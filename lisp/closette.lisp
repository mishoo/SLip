...
(defconstant <float>                 (defclass float (number) ()))
...
(defconstant <text-input-stream>     (defclass text-input-stream (input-stream) ()))
(defconstant <text-output-stream>    (defclass text-output-stream (output-stream) ()))
...
(defun built-in-class-of (x)
  (cond
    ...
    ((packagep x)                                     <package>)
    ((threadp x)                                      <thread>)
    ((%:%text-input-stream-p x)                       <text-input-stream>)
    ((%:%input-stream-p x)                            <input-stream>)
    ((%:%text-output-stream-p x)                      <text-output-stream>)
